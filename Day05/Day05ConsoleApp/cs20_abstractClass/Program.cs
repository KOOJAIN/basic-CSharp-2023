...
{
    abstract class AbstractParent // 추상 메서드는 추상 클래스에 넣습니다. 즉 추상 메서드를 사용하고 싶으면 추상 클래스를 쓰면 됩니다.. 기능ㅇ은 인터페이스와 동일
    {
        ...
        public abstract void MethodC(); // 인터페이스랑 동일!       = 추상메서드     //구현이 없습 밑에서 재정의함
    }
    ...
    class Dogs : Mammal     // Dogs는 추상클래스 구현 해주어야 한다(alt + enter 눌러서 거기 목록차에있습)
    {
    ...
    class Cats : Mammal     // Dogs는 추상클래스 구현 해주어야 한다(alt + enter 눌러서 거기 목록차에있습) //어? Cat class는 자동 추상클레스 돼 있네?
    {
        public override void Sound()
        {
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //parent.MethodA(); // protected는 자기ㅅ자신과 자식클래스 내에서만 사용가능
        }
    }
}
